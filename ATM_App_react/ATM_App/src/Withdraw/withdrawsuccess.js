...
class WithdrawSuccess extends Component {
    ...
    Confirm() {
        ...
        var currentAmount = parseInt(data.balance) - parseInt(this.props.match.params.amount);
        accdata.balance = currentAmount;
                ...
                <div className='m-content'>
                    <div class="m-portlet m-portlet--tabs bgColorBlue">
                        ...
                        <div className='container'>
                            ...
                            <h1 className='colorW'>Please collect your cash.</h1>
